...
app.get('/call', function(req, res) {
    ...
    if (!emailCaller.match(emailPattern) || !emailCallee.match(emailPattern)) {
        var errStr = 'Bad Request. Ensure you have encoded a valid email address for both caller and callee.';
    ...
    var cloudReceiver, regStatus, user;
            ...
            case RegStatus.REGISTERED:
                ...
                var notificationCallback = function(err, messageId) {
                    if (err) {
                        ...
                        sendEmail(emailCaller, emailCallee, room, mailCallback, actionType);
                    } else {
                ...
                sendCloud(emailCaller, endpointArn, room, emailCallee, notificationCallback,
